    ...
    const result = await db.collection('opportunities').aggregate([
        {
            ...
            '$project': {
                ...
                'criteria_value': {
                    '$ifNull': [
                        '$contacts.questions.criteria_value', '$contacts.questions.answers.criteria_value'
                    ]
                },
                'contacts.questions.label': 1,
                'contacts.questions.raw_text': 1,
                                    ...
                                    '$and': [
                                        {
                                            ...
                                            '$or': [
                                                {
                                                    '$eq': [
                                                        '$contacts.questions.answers.loopInstances.loop_instance', '$contacts.win_vendor.value'
                                                    ]
                                                }, {
                                                    '$eq': [
                            ...
                            '$ifNull': [
                                {
                                    '$arrayElemAt': [
                                        {
                                            '$arrayElemAt': [
                                                '$criteria.versions.definition', 0
                                            ]
                                        }, 0
                                    ]
                                }, {
